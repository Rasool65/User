...
import { StylePrice } from '@uikits/product/style';
import ClickAwayListener from '@material-ui/core/ClickAwayListener';
export const DebtTable: FunctionComponent<IDebtCreditUnsettledProp> = (
  props
) => {
  ...
  const getOrders = () => {
    setLoading(true);
    getRequest(
      'http://127.0.0.1:3500/getdebt'
      // `${USER_PANEL_GET_DEBT_OR_CREDIT_API}?IsDebtor=true`
    )
      .then((response) => {
