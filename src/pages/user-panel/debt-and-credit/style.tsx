...
`;
export const StyleIconAscending = styled.div<{ ascending?: boolean }>`
  cursor: pointer;
  > img {
    filter: ${(props) =>
      props.ascending
        ? 'invert(13%) sepia(71%) saturate(6660%) hue-rotate(353deg) brightness(103%) contrast(84%)'
        : 'black'};
  }
`;
export const StyleIconDescending = styled.div<{ descending?: boolean }>`
  cursor: pointer;
  > img {
    filter: ${(props) =>
      props.descending
...
export const StyleNumber = styled.div`
  ...
  text-align: right;
`;
export const StyleSortMenu = styled.div<{ active: number }>`
  > p.dueDate {
    margin: 10px;
    cursor: pointer;
    color: ${(props) => (props.active == 1 ? colorPalette.red_100 : '')};
    :hover {
  ...
  > p.postingDate {
    margin: 10px;
    cursor: pointer;
    color: ${(props) => (props.active == 2 ? colorPalette.red_100 : '')};
    :hover {
      color: ${colorPalette.red_100};
    }
  }
  > p.amount {
    margin: 10px;
    cursor: pointer;
    color: ${(props) => (props.active == 3 ? colorPalette.red_100 : '')};
    :hover {
      color: ${colorPalette.red_100};
    }
  }
  > p.arrearsAfterNetDueDate {
    margin: 10px;
    cursor: pointer;
    color: ${(props) => (props.active == 4 ? colorPalette.red_100 : '')};
    :hover {
      color: ${colorPalette.red_100};
    }
  }
  > p.checkNumber {
    margin: 10px;
    cursor: pointer;
    color: ${(props) => (props.active == 5 ? colorPalette.red_100 : '')};
    :hover {
      color: ${colorPalette.red_100};
    }
  }
`;
export const StyleDivSort = styled.div`
  > div.sortDiv {
    padding: 7px;
    justifycontent: center;
    position: absolute;
