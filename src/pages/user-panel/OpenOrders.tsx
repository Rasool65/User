...
const UserPanelOpenOrders = () => {
  ...
  const getOrders = (
    ...
    setLoading(true);
    getRequest(
      `${USER_PANEL_ORDER_API}?isPaid=false&page=${page ? page : 1}&Limit=${
        limit ? limit : 5
  ...
  const changePage = (page) => {
    ...
    dispatch(PageUrlAction(USER_PANEL_OPEN_ORDERS));
  };

  useEffect(() => {
    if (currentPageUrl === USER_PANEL_OPEN_ORDERS) {
...
export default UserPanelOpenOrders;
